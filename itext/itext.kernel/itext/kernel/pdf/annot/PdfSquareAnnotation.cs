...
namespace iText.Kernel.Pdf.Annot {
    public class PdfSquareAnnotation : PdfMarkupAnnotation {
        ...
        public override PdfAnnotation SetBorderStyle(PdfName style) {
            return ((iText.Kernel.Pdf.Annot.PdfSquareAnnotation)SetBorderStyle(BorderStyleUtil.SetStyle(GetBorderStyle
                (), style)));
        }
        ...
        public override PdfAnnotation SetDashPattern(PdfArray dashPattern) {
            return ((iText.Kernel.Pdf.Annot.PdfSquareAnnotation)SetBorderStyle(BorderStyleUtil.SetDashPattern(GetBorderStyle
                (), dashPattern)));
        }
        ...
        public override PdfMarkupAnnotation SetInteriorColor(float[] interiorColor) {
            return ((iText.Kernel.Pdf.Annot.PdfSquareAnnotation)SetInteriorColor(new PdfArray(interiorColor)));
        }
    }
}
